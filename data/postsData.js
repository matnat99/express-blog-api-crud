...
const posts = [
  {
    ...
    content:
      "Oggi ho preparato un soffice ciambellone al profumo di limone. Perfetto per la colazione o una merenda golosa! 🍋",
  ...
  },
  {
    ...
    content:
      "Croccanti cracker alla barbabietola, ideali per uno snack leggero o come accompagnamento a un aperitivo. Provare per credere! 😋",
  ...
  },
  {
    ...
    content:
      "Chi non ama il pane fritto dolce? Una ricetta semplice e deliziosa che riporta indietro nel tempo. Da gustare con un po' di zucchero sopra! ✨",
  ...
  },
  {
    ...
    content:
      "Ho preparato una pasta cremosa alla barbabietola, dal colore intenso e dal sapore sorprendente. Perfetta per stupire gli ospiti! 🎨",
  ...
  },
  {
    ...
    content:
      "Una torta rustica e ricca di sapore, fatta con pane raffermo, cacao, uvetta e pinoli. Il dessert perfetto per non sprecare nulla! 🥖",
